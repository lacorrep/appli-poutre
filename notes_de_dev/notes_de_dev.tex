...
\item Poutres d'Euler-Bernoulli : les sections restent perpendiculaires à la ligne moyenne \todo{(la rotation de la section est identique à la pente de la déformée)}
\end{itemize}
